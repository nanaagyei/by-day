    ...
    <footer className="border-t bg-background">
      <div className="container px-4 py-8 md:px-6 md:py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Connecting clients with skilled professionals for on-demand services.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/services/home-maintenance" className="text-muted-foreground hover:text-foreground">
                  Home Maintenance
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/dispute" className="text-muted-foreground hover:text-foreground">
                  Dispute Resolution
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} ByDay. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )

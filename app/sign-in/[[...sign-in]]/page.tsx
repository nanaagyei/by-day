...
export default function SignInPage() {
  ...
  // Use afterSignInUrl to redirect based on user type
  const afterSignInUrl = userType === "professional" ? "/professionals/dashboard" : "/clients/dashboard"
    ...
    return (
      <div className="container flex flex-col items-center justify-center min-h-[80vh]">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-muted-foreground">Preparing your sign-in experience...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="container flex flex-col items-center justify-center min-h-[80vh] px-4 py-8 md:px-6">
      <div className="w-full max-w-md">
        <h1 className="text-2xl font-bold text-center mb-6">Welcome to ByDay</h1>
        ...
        <SignIn 
          ...
          signUpUrl={userType === "professional" ? "/sign-up?type=professional" : "/sign-up"}
        />
      </div>
    </div>
  )
